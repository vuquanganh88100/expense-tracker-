...
public class HomeController {
    ...
    public void redirectToLogin() {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/com/example/ltnc/login.fxml"));
    ...
    public void logout(){
        ...
        private void dashboard() {
            loadContent("/com/example/ltnc/dashboard.fxml");
        }

        @FXML
        private void category() {
            loadContent("/com/example/ltnc/category.fxml");
        }

        @FXML
        private void expense() {
            loadContent("/com/example/ltnc/expense.fxml");
        }

        // Method to load the income content
        @FXML
        private void income() {
            loadContent("/com/example/ltnc/income.fxml");
        }
